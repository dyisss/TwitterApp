...
public class Status {
    ...
    public Status(String created_at , int id , String id_str , String text, Boolean trunacated ,Entity entity , String source , int in_reply_to_status_id ,String in_reply_to_status_id_str , String in_reply_to_screen_name ,User user,boolean is_quote_status,int Retweet_count , int Favorite_count,boolean Retweeted , String lang){
